...
contract('ValueChain', function(accounts) {
    ...
    it("Testing smart contract function catchTuna() that allows a Fisherman to catch Tuna", async() => {
        ...
        await valueChain.addFisherman(accounts[1], {from: accounts[1]})
        await valueChain.catchTuna(upc, originFishermanID, originCoastLocation, {from: accounts[1]})

        // Retrieve the just now saved item from blockchain by calling function fetchItem()
        const resultBufferOne = await valueChain.queryTuna(upc, {from: accounts[1]})
    ...
    it("Testing smart contract function recordTuna() that allows a Fisherman to record Tuna Fish details", async() => {
        ...
        await valueChain.recordTuna(upc, tunaPrice, tunaNotes, {from: accounts[1]})

        // Retrieve the just now saved item from blockchain by calling function fetchItem()
        const resultBufferOne = await valueChain.queryTuna.call(upc, {from: accounts[1]})
    ...
    it("Testing smart contract function auditTuna() that allows a Regulator to record Tuna Fish audit details", async() => {
        ...
        // Record Tuna details by calling function recordTuna()
        auditStatus = "Passed"
        await valueChain.addRegulator(accounts[2], {from: accounts[2]})
        await valueChain.auditTuna(upc, auditStatus, {from: accounts[2]})

        // Retrieve the just now saved item from blockchain by calling function fetchItem()
        const resultBufferOne = await valueChain.queryTuna.call(upc)
    ...
    it("Testing smart contract function buyTuna() that allows a Restaurant to buy Tuna Fish", async() => {
        ...
        await valueChain.addRestaurant(accounts[3], {from: accounts[3]})
        await valueChain.buyTuna(upc, price, {from: accounts[3], value: price})
      ...
      it("Testing smart contract function transferOwnership that allows assigning a new owner", async() => {
        ...
        await valueChain.transferOwner(accounts[5], {from: accounts[0]})
        const newOwner = await valueChain.owner()
